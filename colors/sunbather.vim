...
let s:active = s:pink
if &background == "dark"
	let s:dark_active = s:dark_pink
	let s:light_active = s:light_pink
else
	let s:dark_active = s:light_pink
	let s:light_active = s:dark_pink
endif
...
call s:h("Search",        {"bg": s:dark_active, "fg": s:light_black})
...
call s:h("TabLineSel",    {"fg": s:subtle_black, "bg": s:pink, "gui": s:thebold, "cterm": s:thebold})
...
" which-key.nvim
call s:h("WhichKey",                {"bg": s:bg, "fg": s:pink, "gui": s:thebold, "cterm": s:thebold})
